...
const AboutUs = () => {
  return (
    ...
    >
      {/* Hero Section */}
      <section
        className="relative py-20 px-4 sm:px-6 lg:px-8 mt-4"
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p
            ...
            style={{ fontFamily: "var(--font-poppins)", color: "var(--text-color)"}}
          >
            Pioneering the future of premium snacking through artisanal
            craftsmanship, sustainable agriculture, and an unwavering commitment
            to extraordinary flavor experiences.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              >
                <p>
                  Since our founding in 2018, Hues & Harvest has emerged as the
                  premier artisanal chip manufacturer in the Pacific Northwest,
                  transforming how consumers experience gourmet snacking. Our
                  journey began with a simple yet revolutionary idea: that
                  exceptional chips should celebrate the natural diversity and
                  rich flavors of locally-sourced, organic ingredients.
                </p>
                <p>
                  What distinguishes us in the competitive snack industry is our
                  unwavering dedication to small-batch production, traditional
                  kettle-cooking methods, and direct partnerships with certified
                  organic farms. Every chip we produce represents our commitment
                  to culinary excellence, environmental stewardship, and
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <p
                ...
                style={{ color: "var(--muted-text)" }}
              >
                To become the global leader in premium, sustainable snacking by
                2030, setting new industry standards for quality, environmental
                responsibility, and social impact while expanding our reach to
                conscious consumers worldwide who value authentic flavors and
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p
              ...
              style={{ color: "var(--muted-text)" }}
            >
              The principles that guide every decision we make and every chip we
              craft
            </p>
          </div>
                ...
                <div className="flex-1 pr-8 text-right">
                  ...
                  >
                    ...
                    >
                      ...
                      our award-winning Heritage Vegetable Collection featuring
                      heirloom varieties.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex-1 pl-8">
                  ...
                  >
                    ...
                    <p
                      ...
                      style={{ color: "var(--muted-text)" }}
                    >
                      Achieved B-Corp certification, launched our carbon-neutral
                      packaging initiative, and established the Hues & Harvest
                      Foundation to support sustainable agriculture education.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            <div className="group text-center">
              ...
              <p
                ...
                style={{ color: "var(--muted-text)" }}
              >
                Former food scientist at Unilever with 15 years of experience in
                sustainable food production. Sarah holds an MS in Food Science
                from UC Davis and is a certified B-Corp leader.
              </p>
            ...
            <div className="group text-center">
              ...
              <p
                ...
                style={{ color: "var(--muted-text)" }}
              >
                Award-winning chef with Michelin-starred restaurant experience.
                Marcus brings innovative flavor development and traditional
                cooking techniques to our production process.
              </p>
              <div className="text-xs" style={{ color: "var(--muted-text)" }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              >
                ...
                methods with cutting-edge food safety technology to create chips
                of unparalleled quality and flavor.
              </p>
                ...
                <div className="flex items-start space-x-5">
                  ...
                  <div>
                    ...
                    >
                      ...
                      sourced exclusively from certified farms within 200 miles
                      of our facilities, ensuring peak freshness and supporting
                      local agriculture.
                    </p>
                  </div>
                </div>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <p
                  ...
                  style={{ color: "var(--muted-text)" }}
                >
                  Supporting local food banks, agricultural education programs,
                  and providing fair wages to all workers in our supply chain.
                </p>
                <div
                  className="flex items-center text-xs"
                  style={{ color: "var(--success-color)" }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              ...
              <p
                ...
                style={{ color: "var(--muted-text)" }}
              >
                Meets highest standards of social and environmental performance,
            ...
            >
              ...
              <p
                ...
                style={{ color: "var(--muted-text)" }}
              >
                Recognized for exceptional growth and innovation in the food and
                beverage industry.
              </p>
            </div>
          </div>
